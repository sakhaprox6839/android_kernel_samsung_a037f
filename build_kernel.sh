...
export KBUILD_BUILD_USER=$(sakhaprox)
export KBUILD_BUILD_HOST=$(sakhaprox)
...
export LOCALVERSION="-A037F_KERNEL-$(echo $GIT_BRANCH)-$(echo $GIT_TAGS)"
...
case $1 in
    ...
    "menuconfig")
        ...
        ;;
    "kernelsu")
        curl -LSs "https://gitlab.aquacommunity.org/aosp/kernelsu/-/raw/main/kernel/setup.sh" | bash -
        wget https://gist.githubusercontent.com/ArcticAquila/31d88bdddd4f575fda5a8efa408360ed/raw/9851617f8b2f35473ef7dd58e5329cdac976dfc7/ksu.patch
        git apply ksu.patch
        ;;
    "prepare")
